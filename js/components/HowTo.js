        ...
        <View style={styles.howto}>
          ...
          {Platform.OS !== "android" ? (
            <View style={styles.howto}>
              ...
              <Text style={styles.howToText}>
                So you love your artwork! We don't blame you, its amazing. The
                camera button in view will take a screenshot (after asking
                permission the first time, of course) without those pesky
                spraycans or other buttons involved then save it to your
              ...
              <Text style={styles.howToText}>
                ...
                touch the "Check Pieces Out" on the Homebase to see the Gallery,
